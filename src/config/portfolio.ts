...
在过去的实习经历中，我在新产业生物医疗（上市公司）和深密信安科技担任后端研发工程师，积累了丰富的实际项目经验。我在一个月内独立完成生化设计变更管理系统后端开发，完成数据库建模（24张表）与核心业务开发（14状态×5流程通道）。在工作中，我深入研究 Spring Boot、MyBatis-Plus、MySQL 主从复制等技术，并成功解决了分布式事务、性能优化、多数据源管理等实际问题。
...
期待能加入一个技术氛围浓厚的团队，与优秀的同事一起成长，用技术创造价值。`, // TODO: 详细的自我介绍，支持换行
  ...
  projects: [
    ...
    {
      name: '海外论坛系统',
      description: '在新产业生物医疗实习期间开发的海外论坛平台，实现流式处理、文件安全管理、多云存储等功能。',
      tech: ['Spring Boot', '腾讯云 COS', 'PDF处理', 'OSS'],
      image: '',
      github: '',
      demo: '',
      highlights: [
        '流式处理解决 COS 大文件下载导致的 OOM 问题',
        '设计模块化文件安全管理，支持 PDF 权限控制、水印添加、多存储策略（COS/本地/OSS）',
        '优化分片上传同步控制机制，解决高并发场景下内存与文件系统状态不一致问题',
      ],
    },
    {
      name: '元元智能记账',
